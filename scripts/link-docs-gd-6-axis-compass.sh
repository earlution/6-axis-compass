#!/usr/bin/env bash
# Mount Google Drive "6-Axis Compass" at docs-gd-6-axis-compass/ (gitignored infrastructure).
# Canonical docs live in git-tracked docs/ — use sync-docs-*.sh to keep them aligned.
#
# Usage:
#   bash scripts/link-docs-gd-6-axis-compass.sh
...
LINK="$REPO_ROOT/docs-gd-6-axis-compass"
...
echo "Mounted Drive → docs-gd-6-axis-compass/"
ls -la "$LINK"
